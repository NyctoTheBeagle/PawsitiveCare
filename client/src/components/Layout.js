    ...
    return (
      ...
      <div className="main">
        <div className="layout">
          ...
          <div className="logo">
          <img src={Images.Logo1} alt="Your Vets Animal Clinic Logo" className="logo-image w-100" />
           </div>
            ...
            <div id="custom-dropdown-container" className="custom-dropdown-container pr-15">
                {user && user.isAdmin && (
                  <Dropdown overlay={guestMemberMenu} trigger={['click']} placement="bottomRight" getPopupContainer={getPopupContainer}>
                    <a
                      className="ant-dropdown-link text-white"
                      onClick={(e) => e.preventDefault()}
                      style={{ cursor: 'pointer' }}
                    >
                      <i className="fa-solid fa-users dropdown-icon"></i> <DownOutlined />
                    </a>
                  </Dropdown>
                )}
              </div>
                ...
                {user && user.notification.length > 0 ? (
                  <div className="relative inline-block">
                    <Link to="/notification">
                      <i
                        style={{ cursor: 'pointer' }}
                        className="fa-solid fa-bell text-2xl w-11 ml-5"
                      ></i>
                    </Link>

                    <span className="absolute right-4 -mt-1 -mr-1 bg-red-500 text-white rounded-full space-x-5 px-2">
                  ...
                  <Link to="/notification">
                    <i
                      style={{ cursor: 'pointer' }}
                      className="fa-solid fa-bell text-2xl justify-center"
                    ></i>
                  </Link>
                )}

                <button onClick={toggleProfileDialog} className="profile-button">
                  <i className="fa-solid fa-user text-2xl pr-10 pl-5"></i>
                </button>
