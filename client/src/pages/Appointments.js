...
const Appointments = () => {
  ...
  const columns = [
  ...
  },
    {
      ...
      render: (text, record) => (
<div>
          <Button className='bg-primary ml-2 mr-2' type='primary' onClick={() => handleEditAppointment(record)}>Edit <i class='pl-2 fa fa-edit'></i></Button>
          <Button className='bg-warning mt-2' type='primary' onClick={() => handleDeleteAppointment(record)}>Cancel <i class='pl-2 fa fa-close'></i></Button>
        </div>
      ),
    },
  ];
  ...
  return (
    <Layout style={{ margin: 0, padding: 0 }}>
      ...
      <Table className='ml-10 mr-10 mt-3' columns={columns} dataSource={appointments} />
      </div>
      <Modal
