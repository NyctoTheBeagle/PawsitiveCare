...
const ClientRecords = () => {
...

        {
            ...
            render: (text, record) => (
                <div className='d-flex justify-center'>
                    <Button className='btn bg-primary text-white w-50 py-1' onClick={() => handleEditRecord(record)}>Edit <i class="pl-2 fa fa-edit"></i></Button>
                    <Button className='btn bg-secondary ml-1 text-white w-50 py-1' onClick={() => handleRecordDetails(record)}>View <i class="pl-2 fa fa-eye"></i></Button>
                    <Button className='btn bg-danger ml-1 text-white w-50 py-1' onClick={() => showDeleteModal(record)}>Delete <i class="pl-2 fa fa-trash"></i></Button>
                </div>
            ),
        },
    ];
    ...
    return (
        <Layout style={{ margin: 0, padding: 0 }}>
            ...
            <h1 className='mt-24 text-3xl font-bold ml-10 mb-3 text-center'><span class='text-secondary'>Pet</span> <span class='text-primary'>Owners</span> <span class='text-warning'>Records</span></h1>
            <Link className='text-primary ml-10' to="/admin/create-client-records">Add Client Record</Link>
            <Table className='ml-10 mr-10' columns={columns} dataSource={clientRecords} />
