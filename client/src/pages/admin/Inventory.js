...
const Inventory = () => {
    ...
    return (
        <Layout style={{ margin: 0, padding: 0 }}>
            ...
            <div className='ml-20 mr-20 mb-3'>
            <Link className=' mt-2 mb- px-2 text-primary' to="/admin/add-product">Add Product</Link>
            ...
            <Table className='ml-20 mr-20' columns={columns} dataSource={products} />
