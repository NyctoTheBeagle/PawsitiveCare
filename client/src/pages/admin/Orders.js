...
const Orders = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => (
                <div>
                    <Button className='btn bg-danger text-white p-1 m-0 w-50 px-2' onClick={() => handleDeleteOrder(record)}>Delete <i class="pl-2 fa fa-trash"></i></Button>
                </div>
            ),
        },
    ];
    ...
    return (
        <Layout style={{ margin: 0, padding: 0 }}>
            ...
            <Table className='ml-20 mr-20' columns={columns} dataSource={orders} />
